...
public class Trench extends Building {
	
	// Static fields --------------------------------
	
	private static final long serialVersionUID = -625684235031160898L;
	
	public static final String type = "trench";
	@Override public String getType() {
		return super.getType() + "." + Trench.type;
	}
	...
	public Trench(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
