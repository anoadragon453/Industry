...
public class Bank extends Building {
	...
	private static final long serialVersionUID = 5352465749539254783L;
	
	public static final String type = "bank";
	@Override public String getType() {
		return super.getType() + "." + Bank.type;
	}
	...
	public Bank(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
