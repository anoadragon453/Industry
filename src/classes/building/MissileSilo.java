...
public class MissileSilo extends Building {
	...
	private static final long serialVersionUID = 4121591878181144070L;
	
	public static final String type = "missilesilo";
	@Override public String getType() {
		return super.getType() + "." + MissileSilo.type;
	}
	...
	public MissileSilo(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
