...
public class TrainStation extends Building {
	...
	@Typed.Type public static final String type = "trainstation";
	...
	public TrainStation(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
