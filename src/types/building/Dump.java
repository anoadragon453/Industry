...
public class Dump extends Building {
	
	// Static fields --------------------------------
	
	private static final long serialVersionUID = 5947745352803887539L;
	
	public static final String type = "dump";
	...
	public Dump(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + Dump.type;
	}
