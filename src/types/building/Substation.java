...
public class Substation extends Building {
	...
	private static final long serialVersionUID = -2628012551686018050L;
	
	public static final String type = "substation";
	...
	public Substation(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + Substation.type;
	}
