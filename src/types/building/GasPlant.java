...
public class GasPlant extends Building {
	
	// Static fields --------------------------------
	
	private static final long serialVersionUID = -3718449744428021703L;
	
	public static final String type = "gasplant";
	...
	public GasPlant(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + GasPlant.type;
	}
