...
public class VehicleFactory extends Building {
	...
	@Typed.Type public static final String type = "vehiclefactory";
	...
	public VehicleFactory(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
