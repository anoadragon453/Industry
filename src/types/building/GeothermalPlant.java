...
public class GeothermalPlant extends Building {
	...
	@Typed.Type public static final String type = "geothermalplant";
	...
	public GeothermalPlant(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
