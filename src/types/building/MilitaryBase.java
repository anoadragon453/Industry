...
public class MilitaryBase extends Building {
	...
	@Typed.Type public static final String type = "militarybase";
	...
	public MilitaryBase(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
