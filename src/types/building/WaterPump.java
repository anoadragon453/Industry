...
public class WaterPump extends Building {
	...
	private static final long serialVersionUID = -1186990448265888926L;
	...
	public WaterPump(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
