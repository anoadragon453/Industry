...
public class CoalPlant extends Building {
	...
	@Typed.Type public static final String type = "coalplant";
	...
	public CoalPlant(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
	...
	@Override public String getType() {
		return super.getType() + "." + CoalPlant.type;
	}
