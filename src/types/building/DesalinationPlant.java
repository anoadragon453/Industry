...
public class DesalinationPlant extends Building {
	...
	@Typed.Type public static final String type = "desalinationplant";
	...
	public DesalinationPlant(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
