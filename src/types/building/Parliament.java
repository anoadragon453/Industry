...
public class Parliament extends Building {
	...
	private static final long serialVersionUID = -4050036426983825008L;
	
	public static final String type = "parliament";
	...
	public Parliament(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + Parliament.type;
	}
