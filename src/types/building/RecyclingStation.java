...
public class RecyclingStation extends Building {
	...
	@Typed.Type public static final String type = "recyclingstation";
	...
	public RecyclingStation(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
