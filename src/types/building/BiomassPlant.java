...
public class BiomassPlant extends Building {
	...
	@Typed.Type public static final String type = "biomassplant";
	...
	public BiomassPlant(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
