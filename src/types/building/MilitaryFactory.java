...
public class MilitaryFactory extends Building {
	...
	@Typed.Type public static final String type = "militaryfactory";
	...
	public MilitaryFactory(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
