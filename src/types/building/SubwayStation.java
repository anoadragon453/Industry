...
public class SubwayStation extends Building {
	...
	@Typed.Type public static final String type = "subwaystation";
	...
	public SubwayStation(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
