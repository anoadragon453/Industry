...
public class SpaceProgram extends Building {
	...
	@Typed.Type public static final String type = "spaceprogram";
	...
	public SpaceProgram(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Country country) {
