...
public class TransferStation extends Building {
	
	// Static fields --------------------------------
	
	private static final long serialVersionUID = -4552224943707740224L;
	
	public static final String type = "transferstation";
	...
	public TransferStation(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + TransferStation.type;
	}
