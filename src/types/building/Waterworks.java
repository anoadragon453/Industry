...
public class Waterworks extends Building {
	
	// Static fields --------------------------------
	
	private static final long serialVersionUID = -4887138929276010241L;
	
	public static final String type = "waterworks";
	...
	public Waterworks(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + Waterworks.type;
	}
