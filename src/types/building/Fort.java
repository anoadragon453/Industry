...
public class Fort extends Building {
	...
	private static final long serialVersionUID = -3267918870959008492L;
	...
	public Fort(int coordinate_tile_x, int coordinate_tile_y, byte orientation, Player owner) {
	...
	@Override public String getType() {
		return super.getType() + "." + Fort.type;
	}
